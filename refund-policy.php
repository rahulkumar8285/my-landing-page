...
<div class="container py-5">
    <div class="card">
        <div class="card-body">
            ...
            <h4 class="text-dark mt-4">Eligibility for Returns</h4>
            <ul class="list-group list-group-flush">
                <li class="list-group-item">The item must be in its <strong>original condition</strong>, unworn or unused, with <strong>tags attached</strong>, and in its <strong>original packaging</strong>.</li>
                <li class="list-group-item">A <strong>receipt or proof of purchase</strong> is required.</li>
            </ul>

            <h4 class="text-dark mt-4">Return Process</h4>
