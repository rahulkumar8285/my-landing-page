    ...
    <div class="container py-4">
      <div class="row">
        ...
        <div class="col-lg-6">
          <!-- Product Title -->
          <h2 class="h4 mb-3">
            NoirÉlan Multi-color Water Proof Foldable Travel Duffel Bag With Pocket (Free
            Shipping)
          </h2>
                  ...
                  >
                    <defs>
                      <linearGradient id="grad">
                        <stop offset="70%" stop-color="#FFD232"></stop>
                        <stop offset="70%" stop-color="#D3D3D3"></stop>
                      </linearGradient>
                    </defs>
                    <path
                      fill="url(#grad)"
          ...
          <!-- Quantity Selection -->
          <div class="mb-4">
            <p class="fw-bold mb-3">Quantity</p>
          ...
          <!-- Add to Bag -->
          <button class="btn btn-dark w-100 mb-4 py-2">Order Now</button>
          ...
          <div class="mb-4">
            ...
            <div class="collapse collapse-content" id="productDescription">
          ...
          <div class="mb-3">
            <div class="reviews-section" id="reviews-section">
                    ...
                    <div class="rating-score"><svg
                      ...
                      >
                        <path
                          ...
                          d="M5.58 1.15a.5.5 0 0 1 .84 0l1.528 2.363a.5.5 0 0 0 .291.212l2.72.722a.5.5 0 0 1 .26.799L9.442 7.429a.5.5 0 0 0-.111.343l.153 2.81a.5.5 0 0 1-.68.493L6.18 10.063a.5.5 0 0 0-.36 0l-2.625 1.014a.5.5 0 0 1-.68-.494l.153-2.81a.5.5 0 0 0-.11-.343L.781 5.246a.5.5 0 0 1 .26-.799l2.719-.722a.5.5 0 0 0 .291-.212L5.58 1.149Z"
                        ></path>
                      </svg> 4.8  <div class="rating-count">125 ratings</div></div>
                ...
                <div class="rating-bar">    
                    ...
                    <div class="bar">
                        <div class="fill" style="width: 55.8%;"></div> 
                    </div>
                </div>
                <div class="rating-bar">
                    <div class="stars">4  <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="1em"
                        height="1em"
                        fill="none"
                    ...
                    <div class="bar">
                        <div class="fill" style="width: 32.5%;"></div>
                    </div>
                </div>
                <div class="rating-bar">
                    <div class="stars">3  <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="1em"
                        height="1em"
                        fill="none"
                    ...
                    <div class="bar">
                        <div class="fill" style="width: 11.5%;"></div>
                    </div>
                </div>
                <div class="rating-bar">
                    <div class="stars">2  <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="1em"
                        height="1em"
                        fill="none"
